...
In this tutorial, we'll learn how to build a simple RSVP system using Meteor and React. We'll learn how to create a collection of events, and invitees to events, and send invitations to users via email
